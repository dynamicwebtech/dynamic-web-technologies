...
export default function Portfolio({ PH_ICONS_DATA, PH_PORTFOLIO_DATA }) {
  ...
  const TOP_HERO_OBJECT = {
    ...
    heading: "Our Work.",
    text: "Our team at Dynamic Web Technologies has many years of experience building websites and helping local Winston-Salem, NC, businesses gain more attention under its belt. Get a look at our previous work below to see what we can offer you!",
  };
